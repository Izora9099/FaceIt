...
public class TakeAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finishButton.setOnClickListener(v -> {
            if (isCameraReady) {
                ...
                Toast.makeText(TakeAttendance.this, "Camera not ready yet. Please wait...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        imageCapture.takePicture(outputOptions, ContextCompat.getMainExecutor(this),
                new ImageCapture.OnImageSavedCallback() {
                    ...
                    public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                        Toast.makeText(TakeAttendance.this, "Image captured. Sending to server...", Toast.LENGTH_SHORT).show();
                        uploadToBackend(photoFile);
                    }

                    @Override
                    public void onError(@NonNull ImageCaptureException exception) {
                        Toast.makeText(TakeAttendance.this, "Capture failed: " + exception.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void uploadToBackend(File imageFile) {
        ...
        Call<ApiResponse> call = api.takeAttendance(body);
        call.enqueue(new Callback<ApiResponse>() {
            @Override
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    Toast.makeText(TakeAttendance.this, response.body().message, Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(TakeAttendance.this, "Registration failed: No face found or invalid image.", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                Toast.makeText(TakeAttendance.this, "Network error: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
